...
export default function AccountMarketplace({
  ...
  return (
    <section id="accounts" className="py-24 relative">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-6xl h-[600px] bg-[#F59E0B]/5 rounded-full blur-3xl pointer-events-none" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        {/* Section Header */}
        <div className="text-center max-w-3xl mx-auto mb-14">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-gradient-to-r from-[#F59E0B]/20 to-amber-500/10 border border-[#F59E0B]/40 text-[#F59E0B] text-xs font-bold uppercase tracking-widest mb-4 shadow-glow-gold-sm">
              ...
              return (
                <button
                  ...
                  className={`relative px-6 py-3 rounded-xl text-sm font-extrabold transition-all duration-300 ${
                    isSelected
                      ? "bg-gradient-to-r from-[#F59E0B] to-amber-500 text-black shadow-[0_0_20px_rgba(245,158,11,0.5)] scale-[1.03]"
                      : "text-zinc-400 hover:text-white hover:bg-white/5"
                  }`}
                >
                  {prod.accountSize >= 100000 && (
                    <span className="absolute -top-2.5 right-2 px-1.5 py-0.2 text-[8px] font-black uppercase rounded bg-amber-400 text-black shadow">
                      APEX
                    </span>
                  )}
                  {prod.isFeatured && (
            ...
            <div className="lg:col-span-8 rounded-3xl bg-gradient-to-b from-[#0C1215] to-[#070A0C] border border-white/10 p-8 sm:p-10 shadow-2xl relative overflow-hidden flex flex-col justify-between">
              ...
              <div>
                <div className="flex flex-wrap items-start justify-between gap-4 border-b border-white/10 pb-8">
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      <span className="px-2 py-0.5 rounded text-[10px] font-bold uppercase bg-amber-400/10 text-amber-300 border border-amber-400/20">
                        Institutional Grade
                      </span>
                    </div>
                  ...
                  <div className="text-left sm:text-right">
                    ...
                    <span className="text-xs text-[#F59E0B] font-bold block mt-1">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 my-8">
                  <div className="p-4 rounded-2xl bg-white/[0.02] border border-white/5 hover:border-[#F59E0B]/30 transition-colors">
                  ...
                  <div className="p-4 rounded-2xl bg-[#F59E0B]/10 border border-[#F59E0B]/30">
                    <span className="text-xs text-[#F59E0B] block font-bold uppercase tracking-wider">
                      Simulated Split
                    </span>
                    <span className="text-xl font-extrabold text-[#F59E0B] font-mono mt-1 block">
              ...
              <div className="pt-6 border-t border-white/10 flex flex-wrap items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3 w-full sm:w-auto">
                  ...
                  <Link
                    ...
                    className="w-full sm:w-auto flex items-center justify-center gap-2 px-8 py-3.5 rounded-xl bg-[#F59E0B] hover:bg-[#D97706] text-black text-xs font-extrabold shadow-glow-gold-sm transition-all"
                  >
              ...
              <div>
                ...
                <ul className="space-y-4 text-xs text-zinc-300">
                  <li className="flex items-start gap-3">
                    <span className="w-2 h-2 rounded-full bg-[#F59E0B] mt-1.5 flex-shrink-0 shadow-[0_0_8px_#F59E0B]" />
                    <span>
            ...
            return (
              <div
                ...
                className={`rounded-3xl p-7 transition-all duration-300 border ${
                  isSelected
                    ? "bg-[#0C1215] border-[#F59E0B]/50 shadow-[0_0_30px_rgba(245,158,11,0.2)] scale-[1.01]"
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  {prod.accountSize >= 100000 ? (
                    <span className="px-2.5 py-0.5 rounded-full text-[10px] font-extrabold uppercase bg-amber-400/10 text-amber-400 border border-amber-400/30">
                      Apex Tier
                    </span>
                  ) : prod.isFeatured ? (
                    <span className="px-2.5 py-0.5 rounded-full text-[10px] font-extrabold uppercase bg-[#F59E0B]/15 text-[#F59E0B] border border-[#F59E0B]/40">
                      Featured
                    </span>
                  ) : null}
                </div>
                ...
                <div className="text-sm font-bold text-[#F59E0B] font-mono mt-1">
                  ${prod.priceUSD} USD
                </div>
                ...
                <div className="my-5 pt-5 border-t border-white/10 space-y-2.5 text-xs">
                  ...
                  <div className="flex justify-between text-zinc-400">
                    ...
                    <span className="text-[#F59E0B] font-bold">{prod.rewardSplit}</span>
                  </div>
                </div>
                ...
                <div className="pt-2">
                  <Link
                    ...
                    className="w-full block py-3 rounded-xl bg-white/10 hover:bg-[#F59E0B] hover:text-black text-white text-xs font-bold transition-all text-center"
                  >
                    Select Account
                  </Link>
                </div>
